...
void spi_enter_sleep()
{
   /* Initialize Virtual SPI Bus 1 GPIO */
  GPIO_Init(SPI_BUS_1_SCL_GPIO, SPI_BUS_1_SCL_PIN, GPIO_Mode_Out_PP_Low_Slow);
  GPIO_Init(SPI_BUS_1_MOSI_GPIO, SPI_BUS_1_MOSI_PIN, GPIO_Mode_Out_PP_Low_Slow);
  GPIO_Init(SPI_BUS_1_MISO_GPIO, SPI_BUS_1_MISO_PIN, GPIO_Mode_Out_PP_Low_Slow);
}
