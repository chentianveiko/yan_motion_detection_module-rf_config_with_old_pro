...
void HalResetRtcAlarm(void)
{
  ...
  HalUartConfigSendString("\r\nalarm time:");
  HalUartConfigSendByte(RTC_AlarmStr.RTC_AlarmTime.RTC_Hours/10 + 0x30);
  HalUartConfigSendByte(RTC_AlarmStr.RTC_AlarmTime.RTC_Hours%10 + 0x30);
  HalUartConfigSendByte('-');
  HalUartConfigSendByte(RTC_AlarmStr.RTC_AlarmTime.RTC_Minutes/10 + 0x30);
  HalUartConfigSendByte(RTC_AlarmStr.RTC_AlarmTime.RTC_Minutes%10 + 0x30);
  HalUartConfigSendByte('-');
  HalUartConfigSendByte(RTC_AlarmStr.RTC_AlarmTime.RTC_Seconds/10 + 0x30);
  HalUartConfigSendByte(RTC_AlarmStr.RTC_AlarmTime.RTC_Seconds%10 + 0x30);
  HalUartConfigSendString("\r\n");
