...
#define IMD_LINK_NET_ADDR_DEFAULT     0                 // 默认网络地址
#define IMD_LINK_AREAL_ID_DEFAULT     0                 // 默认区域地址
#define IMD_LINK_GROUP_ID_DEFAULT     0                 // 默认组ID
...
#define LINK_DEVICE_SCAN                  0xA4
#define LINK_DEVICE_SCAN_RESPONSE         0xA5
...
#define LINK_SET_CHANNEL                  0xB1
#define LINK_SET_CHANNEL_RES              0xB2
